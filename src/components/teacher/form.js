            ...
            <div className="rounded-lg overflow-hidden shadow-lg">            
                <div className="px-6 ">
                    ...
                    <div className=" flex flex-wrap ">
                        <div className="w-full flex-wrap md:w-1/3">
                    ...
                    <div className="flex flex-wrap py-3">
                        <div className="w-full flex-wrap md:w-1/3">
                            <FormControl label="Tempat Lahir" id="tempat_lahir">
                                <Input
                        ...
                        <div className="w-full flex-wrap md:w-1/3">
                            <FormControl label="Tanggal Lahir" id="tanggal_lahir">
                                <Input
                                    placeholder="Input Tanggal Lahi"
                                    id="tanggal_lahir"
                                    name="tanggal_lahir"
                                    type="date"
                                    onChange={formik.handleChange}
